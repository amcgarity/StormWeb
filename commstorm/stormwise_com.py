...
stormwise() function:
	...
	and then runs AMPL on the dat file to generate stormwise_com output
...
import yaml
import subprocess
from stormwise_com_ampl import generate_ampl_dat_file
from stormwise_com_ampl import generate_ampl_benefit_file
#from stormwise_com_benefits_and_bounds import benefit_slopes
